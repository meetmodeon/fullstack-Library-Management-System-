...
export function verifyOtp(http: HttpClient, rootUrl: string, params: VerifyOtp$Params, context?: HttpContext): Observable<StrictHttpResponse<{
[key: string]: string;
}>> {
...
verifyOtp.PATH = '/common/otp/verify';
