...
export function updateSubCategory(http: HttpClient, rootUrl: string, params: UpdateSubCategory$Params, context?: HttpContext): Observable<StrictHttpResponse<SubCategoryResponse>> {
...
updateSubCategory.PATH = '/subCategories/{id}';
